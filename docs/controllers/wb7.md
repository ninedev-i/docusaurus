...
Ниже мы рассмотрим основные моменты, полную информацию по настройке сети читайте в статье [Настройка сети в контроллере Wiren Board](/docs/howto/networks.md).
